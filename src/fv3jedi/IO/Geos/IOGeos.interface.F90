...
subroutine c_fv3jedi_io_geos_read_state(c_key_self, c_key_state) &
...
subroutine c_fv3jedi_io_geos_read_increment(c_key_self, c_key_increment) &
...
subroutine c_fv3jedi_io_geos_write_state(c_key_self, c_key_state) &
...
subroutine c_fv3jedi_io_geos_write_increment(c_key_self, c_key_increment) &
