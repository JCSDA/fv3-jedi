...
subroutine c_fv3jedi_io_cube_sphere_history_read_state(c_key_self, c_key_state, c_fileionamesconf, &
                                                       c_fileioscalingconf) &
...
! Call implementation
! -------------------
call f_self%read(f_state%time, f_state%fields, f_fileionamesconf, f_fileioscalingconf)
...
! Call implementation
! -------------------
call f_self%read(f_increment%time, f_increment%fields, f_fileionamesconf, f_fileioscalingconf)
