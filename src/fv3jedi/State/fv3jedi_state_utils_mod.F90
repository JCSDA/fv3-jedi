...
type :: fv3jedi_state
  ...
  real(kind=kind_real), pointer, dimension(:,:,:) :: frlandice => null()
  real(kind=kind_real), pointer, dimension(:,:,:) :: frlake    => null()
  real(kind=kind_real), pointer, dimension(:,:,:) :: frseaice  => null()
