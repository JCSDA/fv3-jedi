...
#ifndef FV3JEDI_MODEL_TRAJ_MODELTRAJFV3JEDI_H_
#define FV3JEDI_MODEL_TRAJ_MODELTRAJFV3JEDI_H_
...
class ModelTrajFV3JEDI: public oops::ModelBase<FV3JEDITraits>,
                       private util::ObjectCounter<ModelTrajFV3JEDI> {
 public:
  static const std::string classname() {return "fv3jedi::ModelTrajFV3JEDI";}

  ModelTrajFV3JEDI(const GeometryFV3JEDI &, const eckit::Configuration &);
  ~ModelTrajFV3JEDI();
...
#endif  // FV3JEDI_MODEL_TRAJ_MODELTRAJFV3JEDI_H_
