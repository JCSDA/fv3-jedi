...
subroutine c_fv3jedi_lvc_model2geovals_multiplyinverse(c_key_self, c_key_geom, c_key_dxg, &
                                                       c_key_dxm) &
           bind (c,name='fv3jedi_lvc_model2geovals_multiplyinverse_f90')
...
! Implementation
! --------------
call self%multiplyinverse(geom, dxg, dxm)

end subroutine c_fv3jedi_lvc_model2geovals_multiplyinverse

! --------------------------------------------------------------------------------------------------

subroutine c_fv3jedi_lvc_model2geovals_multiplyinverseadjoint(c_key_self, c_key_geom, c_key_dxm, &
                                                              c_key_dxg) &
           bind (c,name='fv3jedi_lvc_model2geovals_multiplyinverseadjoint_f90')
...
! Implementation
! --------------
call self%multiplyinverseadjoint(geom, dxm, dxg)

end subroutine c_fv3jedi_lvc_model2geovals_multiplyinverseadjoint
