  ...
  geom_(new Geometry(resol))
{
  ...
  fv3jedi_linvarcha_c2a_create_f90(keyFtnConfig_, geom_->toFortran(),
                               bg.toFortran(),
                               fg.toFortran(),
                               &configc);
