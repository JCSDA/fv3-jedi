...
#ifndef FV3JEDI_ERRORCOVARIANCE_ERRORCOVARIANCEFORTRAN_H_
#define FV3JEDI_ERRORCOVARIANCE_ERRORCOVARIANCEFORTRAN_H_
...
#endif  // FV3JEDI_ERRORCOVARIANCE_ERRORCOVARIANCEFORTRAN_H_
