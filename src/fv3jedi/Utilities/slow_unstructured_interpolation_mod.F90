...
module slow_unstructured_interpolation_mod
...
! Error check
if (procrank>999999) call abor1_ftn("slow_unstructured_interpolation_mod not ready for more than 999999 processors")
...
end module slow_unstructured_interpolation_mod
