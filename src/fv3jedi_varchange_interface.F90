...
subroutine c_fv3jedi_varchange_setup(c_key_self, c_key_state_bg, c_key_state_fg, &
              c_conf) bind (c,name='fv3jedi_varchange_setup_f90')
...
call fv3jedi_varchange_setup(self, bg, fg, c_conf)
