...
#ifndef SRC_LOCALIZATION_INSTANTIATELOCALIZATIONFACTORY_H_
#define SRC_LOCALIZATION_INSTANTIATELOCALIZATIONFACTORY_H_
...
#endif  // SRC_LOCALIZATION_INSTANTIATELOCALIZATIONFACTORY_H_
