...
!TODO precision change
   ...
   case ("PHIS")
     state%phis   (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("FRLAND")
     state%frland (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("FROCEAN")
     state%frocean(isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KCBL_moist")
     state%kcbl   (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("TS_moist")
     state%ts     (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KHl_moist")
     state%khl    (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KHu_moist")
     state%khu    (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("VARFLT")
     state%varflt (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("USTAR")
     state%ustar  (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("BSTAR")
     state%bstar  (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("ZPBL")
     state%zpbl   (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CM")
     state%cm     (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CT")
     state%ct     (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CQ")
     state%cq     (isc:iec,jsc:jec) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case default
