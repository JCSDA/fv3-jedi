...
!TODO precision change
   ...
   case ("U_DGRID")
     state%fields(state%ud)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("V_DGRID")
     state%fields(state%vd)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("U")
     state%fields(state%ua)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("V")
     state%fields(state%va)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("T")
     state%fields(state%t)%array   (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("DELP")
     state%fields(state%delp)%array(isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("DZ")
     state%fields(state%delz)%array(isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("W")
     state%fields(state%w)%array   (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("Q")
     state%fields(state%q)%array   (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("QITOT")
     state%fields(state%qi)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("QLTOT")
     state%fields(state%ql)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("O3")
     state%fields(state%o3)%array  (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("QCLSX0")
     state%fields(state%qls)%array (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("QCCNX0")
     state%fields(state%qcn)%array (isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("CLCNX0")
     state%fields(state%cfcn)%array(isc:iec,jsc:jec,1:npz) = farrayPtr3(lb3(1):ub3(1),lb3(2):ub3(2),lb3(3):ub3(3))
   case ("PHIS")
     state%fields(state%phis)%array   (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("FRLAND")
     state%fields(state%frland)%array (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("FROCEAN")
     state%fields(state%frocean)%array(isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KCBL_moist")
     state%fields(state%kcbl)%array   (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("TS_moist")
     state%fields(state%ts)%array     (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KHl_moist")
     state%fields(state%khl)%array    (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("KHu_moist")
     state%fields(state%khu)%array    (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("VARFLT")
     state%fields(state%varflt)%array (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("USTAR")
     state%fields(state%ustar)%array  (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("BSTAR")
     state%fields(state%bstar)%array  (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("ZPBL")
     state%fields(state%zpbl)%array   (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CM")
     state%fields(state%cm)%array     (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CT")
     state%fields(state%ct)%array     (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case ("CQ")
     state%fields(state%cq)%array     (isc:iec,jsc:jec,1) = farrayPtr2(lb2(1):ub2(1),lb2(2):ub2(2))
   case default
