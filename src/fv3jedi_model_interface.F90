...
subroutine c_fv3jedi_model_propagate(c_key_self, c_key_state) bind(c,name='fv3jedi_model_propagate_f90')
...
subroutine c_fv3jedi_model_propagate_ad(c_key_self, c_key_incr, c_key_traj) &
...
subroutine c_fv3jedi_model_propagate_tl(c_key_self, c_key_incr, c_key_traj) &
