...
#ifndef SRC_INCREMENT_INCREMENTFV3JEDIFORTRAN_H_
#define SRC_INCREMENT_INCREMENTFV3JEDIFORTRAN_H_
...
// -----------------------------------------------------------------------------
  ...
  void fv3jedi_increment_svnorm_f90(const F90inc &,
                                    const F90geom &,
                                    const F90state &,
                                    const eckit::Configuration * const *);
...
#endif  // SRC_INCREMENT_INCREMENTFV3JEDIFORTRAN_H_
