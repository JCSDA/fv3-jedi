...
#ifndef SRC_INCREMENT_INCREMENTFV3JEDI_H_
#define SRC_INCREMENT_INCREMENTFV3JEDI_H_
...
/// Other
  ...
  void jnorm(const StateFV3JEDI &, const eckit::Configuration &);
...
#endif  // SRC_INCREMENT_INCREMENTFV3JEDI_H_
