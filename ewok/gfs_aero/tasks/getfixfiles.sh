...
cp ${FV3REPO}/test/Data/fieldmetadata/gfs-aerosol.yaml ${FIXDIR}/gfs_aero-restart.yaml

cp ${FV3REPO}/test/Data/fv3files/input_gfs_${RESOL}_z64_${LAYOUT}.nml ${FIXDIR}/model_gfs_${RESOL}.nml
