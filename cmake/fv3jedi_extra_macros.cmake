...
# Macro to set Fortran preprocessing flags based on the compiler
macro(set_fortran_preprocessing_flag out_var)
    if(CMAKE_Fortran_COMPILER_ID MATCHES "Intel")
        set(${out_var} "-fpp" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
        set(${out_var} "-cpp" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID STREQUAL "Clang")
        set(${out_var} "-cpp" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "Cray")
        set(${out_var} "-eZ" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "PGI")
        set(${out_var} "-Mpreprocess" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC")
        set(${out_var} "-Mpreprocess" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "XL")
        set(${out_var} "-qsuffix=cpp=f90" PARENT_SCOPE)
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NAG")
        set(${out_var} "-fpp" PARENT_SCOPE)
    else()
        message(WARNING "Unknown Fortran compiler: ${CMAKE_Fortran_COMPILER_ID}. No preprocessor flag set.")
